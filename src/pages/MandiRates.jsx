...
const commoditiesData = [
  {
    name: 'Wheat', emoji: '🌾', trend: 'up', change: '+2.3%',
    min: 2180, max: 2350, modal: 2280, unit: '₹/qtl',
    sparkline: [60, 65, 62, 70, 68, 75, 80],
  },
  {
    name: 'Rice (Basmati)', emoji: '🍚', trend: 'up', change: '+1.8%',
    min: 3400, max: 3850, modal: 3650, unit: '₹/qtl',
    sparkline: [50, 55, 58, 52, 60, 65, 70],
  },
  {
    name: 'Soybean', emoji: '🫘', trend: 'down', change: '-1.2%',
    min: 4200, max: 4600, modal: 4380, unit: '₹/qtl',
    sparkline: [80, 75, 78, 72, 68, 65, 60],
  },
  {
    name: 'Cotton', emoji: '🏵️', trend: 'up', change: '+3.1%',
    min: 6200, max: 6800, modal: 6550, unit: '₹/qtl',
    sparkline: [40, 50, 55, 60, 58, 70, 78],
  },
  {
    name: 'Onion', emoji: '🧅', trend: 'down', change: '-4.5%',
    min: 800, max: 1400, modal: 1100, unit: '₹/qtl',
    sparkline: [90, 85, 80, 70, 65, 55, 50],
  },
  {
    name: 'Tomato', emoji: '🍅', trend: 'stable', change: '+0.2%',
    min: 1200, max: 1800, modal: 1500, unit: '₹/qtl',
    sparkline: [60, 62, 58, 65, 60, 63, 62],
  },
  {
    name: 'Potato', emoji: '🥔', trend: 'up', change: '+1.5%',
    min: 600, max: 950, modal: 780, unit: '₹/qtl',
    sparkline: [45, 50, 55, 52, 60, 65, 68],
  },
  {
    name: 'Maize', emoji: '🌽', trend: 'stable', change: '-0.3%',
    min: 1800, max: 2100, modal: 1950, unit: '₹/qtl',
    sparkline: [55, 58, 56, 60, 58, 55, 57],
  },
  {
    name: 'Mustard', emoji: '🌼', trend: 'up', change: '+2.8%',
    min: 4800, max: 5200, modal: 5050, unit: '₹/qtl',
    sparkline: [50, 55, 60, 58, 65, 72, 78],
  },
]
    ...
    <motion.div className="page-wrapper mandi-page" {...pageTransition}>
      <div className="container">
        ...
        <div className="mandi-last-update">
          <span className="dot" />
          <span>Live — Last updated: 5 minutes ago</span>
            ...
            <ScrollReveal key={item.name} delay={i * 0.05}>
              ...
              >
                ...
                <div className="mandi-price-row">
                  <span className="mandi-price-label">Modal Price</span>
                  <span className="mandi-price-value highlight">₹{item.modal.toLocaleString()}/qtl</span>
                </div>
                <div className="mandi-price-row">
                  <span className="mandi-price-label">Min Price</span>
                  <span className="mandi-price-value">₹{item.min.toLocaleString()}</span>
                </div>
                <div className="mandi-price-row">
                  <span className="mandi-price-label">Max Price</span>
